component accessors="true" extends="framework.one" {
	...
	public function setupApplication(){
		...
		application.configdir = expandpath("../config");
	...
	private function queueSubsystemCSS( subsystem, rc ){
		...
		var overridewebpath = variables.framework.base & "assets/css/subsystems/" & arguments.subsystem & ".css";
		var overridesystempath = application.appDir & "assets/css/subsystems/" & arguments.subsystem & ".css";
		...
		queueSubsystemCssFile( arguments.subsystem, overridesystempath, overridewebpath, variables.csschecks.overridesfound, variables.csschecks.overridesnotfound, rc );
	}
