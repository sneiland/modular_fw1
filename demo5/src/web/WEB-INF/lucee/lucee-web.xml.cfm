<?xml version="1.0" encoding="UTF-8"?><cfLuceeConfiguration hspw="be2c4f5cd6eb62da697232b4f455e4240b120a553ac647d293e87062062d7cf1" salt="7F51D3A0-30D0-4D62-A2A2CF1C21E273AE" version="4.5"><cfabort/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionLimit="-1" connectionTimeout="1" custom="useUnicode=true&amp;characterEncoding=UTF-8&amp;useLegacyDatetimeCode=true" database="demo" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" metaCacheTimeout="60000" name="demo" password="encrypted:fa613835a37deb3373ae518ab08a208ed7fa93a28d295e99be1c16c9f07793c0" port="3306" storage="false" username="root" validate="false"/><data-source allow="511" blob="false" class="org.gjt.mm.mysql.Driver" clob="false" connectionTimeout="1" custom="useUnicode=true&amp;characterEncoding=UTF-8&amp;useLegacyDatetimeCode=true" database="help" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" metaCacheTimeout="60000" name="helpsubsystem" password="encrypted:7be7dcca40b380bb0cf31f05ba2aca4d84ab563036420070c37232a66bc7aa12" port="3306" storage="false" username="demo" validate="false"/></data-sources>
	...
	<mapping inspect-template="" physical="C:\Apache24\htdocs\subsystems\calendar\src" primary="physical" toplevel="true" virtual="/subsystems/calendar"/><mapping inspect-template="" physical="C:\Apache24\htdocs\subsystems\help\src" primary="physical" toplevel="true" virtual="/subsystems/help"/><mapping inspect-template="" physical="C:\Apache24\htdocs\subsystems\security\src" primary="physical" toplevel="true" virtual="/subsystems/security"/><mapping inspect-template="" physical="C:\Apache24\htdocs\common" primary="physical" toplevel="true" virtual="/common"/><mapping inspect-template="" physical="C:\Apache24\htdocs\common\fw1\3_5" primary="physical" toplevel="true" virtual="/framework"/></mappings>	
