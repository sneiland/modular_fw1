...
<head>
	...
	<title>Demo 4 - Calendar Subsystem</title>
	...
	<nav class="navbar navbar-fixed-top navbar-dark bg-primary">
	    ...
	    <div class="collapse navbar-toggleable-xs" id="collapsingNavbar">
	        <ul class="nav navbar-nav pull-right">
	            <li class="nav-item">
	                <cfoutput><a id="helpButton" data-helpaction="#rc.action#" class="nav-link openDialog">Help</a></cfoutput>
	            </li>
	            <li class="nav-item">
	                <cfoutput><a href="#buildUrl(action='security:main.logout')#" class="nav-link">Logout</a></cfoutput>
	            </li>
	        </ul>
	    </div>
	</nav>
	        ...
	        <div class="col-md-3 col-lg-2 sidebar-offcanvas" id="sidebar" role="navigation">
	            <ul class="nav nav-pills nav-stacked">
		            <cfoutput>
						...
						<li class="nav-item"><a class="nav-link" href="#buildUrl('calendar:main')#">Calendar</a></li>
					</cfoutput>
	            </ul>
	        </div>
	        <!--/col-->
			...
			.on(
				...
				function(e){
					...
					if( !$(this).hasClass('disabled') ){
						var helpaction = $(this).data('helpaction');
						ss_help.modal.showHelpDialog( helpaction );
					}
				}
			);
	</script>
